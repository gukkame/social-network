    ...
    <div class="postcard">
        <RouterLink class="d-flex flex-column flex-wrap justify-content-space"
            ...
            <div class="postcardh d-flex flex-row">
                ...
                <div class="col-2 p-1">
                    <img v-if="data.CategoryTitle == `Go`" class="postCategoryImg col" src="../assets/images/Go.svg" />
                    <img v-if="data.CategoryTitle == `HTML5`" class="postCategoryImg col"
                        src="../assets/images/HTML.svg" />
                    <img v-if="data.CategoryTitle == `CSS`" class="postCategoryImg col"
                        src="../assets/images/CSS.svg" />
                    <img v-if="data.CategoryTitle == `JavaScript`" class="postCategoryImg col"
                        src="../assets/images/Javascript.svg" />
                    <img v-if="data.CategoryTitle == `Vue.js`" class="postCategoryImg col"
            ...
            <div class="postcardf d-flex flex-row">
                ...
                <div class="col d-flex justify-content-center">
                    <div class="align-self-center">
                        ...
                        <span class="postReactCount" style="padding-left: 2px;">{{ humanReadableAmount }}</span>
                    </div>
                </div>
                <div class="col d-flex justify-content-center">
                    <div class="align-self-center ">
...
export default {
    ...
    computed: {
        humanReadableTime() {
            return timeago(new Date(Date.now() - new Date(Date.parse(this.data.Created_at ?? "01 Jan 1970 00:00:00 GMT"))))
        },

        humanReadableAmount() {
            if (this.data.Comments == null) {
                return this.data.Comments = 0
            } else {
        ...
        maxlengthdesc() {
            if (this.data.Description.length > 300) {
                return this.data.Description.substring(0, 300) + "..."
            }
