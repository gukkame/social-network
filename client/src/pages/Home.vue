...
<template>
  <div class="d-flex justify-content-center">
    <div class="homeWelcome" v-if="LoggedIn">
      Welcome, <a style="color: #ff9d5a">{{ data }}</a
      >!
    </div>
  ...
  <div class="mainpagec container col">
    <div class="catetitle"><i class="catetitleicon bi bi-calendar"></i>Latest posts</div>
    <div class="d-flex">
  ...
  methods: {
    async fetchData() {
      ...
      await delay(200).then(() => {
        axios
          .post("http://localhost:8080/allcategory", data, config)
          .then((res) => {
